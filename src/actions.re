[@bs.scope "ipcRenderer"] [@bs.module "electron"] external on : (string, 'a => unit) => unit = "";

[@bs.scope "ipcRenderer"] [@bs.module "electron"] external send : (string, 'a) => unit = "";

[@bs.scope "ipcRenderer"] [@bs.module "electron"] external sendSync : (string, 'a) => 'b = "";
