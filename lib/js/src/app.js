...
function make() {
  ...
  newrecord[/* didMount */4] = (function (self) {
      var setNow = function () {
        return Curry._1(self[/* send */4], /* SetNow */Block.__(3, [$$Date.today(/* () */0)]));
      };
      intervalId[0] = /* Some */[setInterval(setNow, 1000)];
      Electron.ipcRenderer.on(Event.openDiary, (function () {
              return Curry._1(self[/* send */4], /* ToggleDiary */0);
            }));
      if (self[/* state */2][/* posts */2] === State.emptyPosts) {
        Actions.getPosts((function (posts) {
                return Curry._1(self[/* send */4], /* SetPosts */Block.__(0, [posts]));
              }));
      }
      if (self[/* state */2][/* post */1] === State.emptyPost) {
        Actions.getPost((function (post) {
                return Curry._1(self[/* send */4], /* SetPost */Block.__(1, [post]));
  ...
  newrecord[/* render */9] = (function (param) {
      ...
      if (match !== 0) {
        ...
        content = ReasonReact.element(/* None */0, /* None */0, ComposePost.make(state[/* fullscreen */4], (function () {
                    return Curry._1(send, /* SetInitialDate */Block.__(2, [$$Date.today(/* () */0)]));
                  }), 1 - $$Date.equals(state[/* initialDate */3], state[/* now */0]), (function (param) {
                    var send$1 = send;
                    ...
                    return Curry._1(send$1, /* SetPost */Block.__(1, [post]));
                  }), state[/* post */1], /* array */[]));
      }
